...
mixin LocalinoProvider {
  ...
  /// Instance of default [Localino] to easily access localization methods.
  @protected
  Localino get localization => instance;

  /// An alias for [Localino.localize].
  @protected
  String localize(String key) => localization.localize(key);

  /// An alias for [Localino.localizeOr].
  @protected
  ...
  /// An alias for [Localino.extractLocalization].
  @protected
